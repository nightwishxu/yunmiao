...
import com.base.security.shiro.realm.RealmFactory;

public class CustomDefaultWEbSecurityManager extends DefaultSecurityManager implements WebSecurityManager{
    ...
    public CustomDefaultWEbSecurityManager() {
        super();
    ...
    @SuppressWarnings({})
    public CustomDefaultWEbSecurityManager(Realm singleRealm) {
        this();
        setRealm(singleRealm);
    }

    @SuppressWarnings({})
    public CustomDefaultWEbSecurityManager(Collection<Realm> realms) {
        this();
        setRealms(realms);
    }
    
    public CustomDefaultWEbSecurityManager(RealmFactory factory){
    	this();
    	setRealms(factory.getRealms());
    }
    ...
    private void applySessionManagerToSessionStorageEvaluatorIfPossible() {
        ...
        if (subjectDAO instanceof DefaultSubjectDAO) {
            ...
            if (evaluator instanceof CustomDefaultWEbSecurityManager) {
                ((CustomDefaultWEbSecurityManager)evaluator).setSessionManager(getSessionManager());
            }
        }
    }
	...
	public RealmFactory getFactory() {
		return factory;
	}

	public void setFactory(RealmFactory factory) {
