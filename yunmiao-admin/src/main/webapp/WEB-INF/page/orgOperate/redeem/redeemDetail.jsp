    ...
    <script type="text/javascript">
        ...
        $(function() {
            if (pawnId != '') {
                ...
                $.post(sy.contextPath + '/userPawn/getRedeemDetail', {
                    pawnId : pawnId
                }, function(result) {
                    if (result) {
                        if(result.images){
    ...
    <div style="padding:15px;font-size: 12px">
        <table style="table-layout:fixed;" border="0" cellspacing="0" class="formtable">
            <tr>
                ...
                <td>
                    <div id = "images" name="images"  type="file" multi="true" fileCountLimit="6" showImage="true" fileType="jpg,png,mp4" fileSize="200MB" ></div>
                </td>
            </tr>
            <tr>
