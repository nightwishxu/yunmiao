...
<head>
    ...
    <script type="text/javascript">
        ...
        function check(id) {
            var url = sy.contextPath + '/go.do?path=orgOperate/redeem/redeemDetail&id='+id;
        ...
        $(function() {
            grid = $('#grid').datagrid({
                url : sy.contextPath + '/userPawn/getRedeemList',
                columns : [ [ {
                    ...
                    formatter : function (v,r,i) {
                        ...
                        formatter : function (v,r,i){
                            if(r.id){
                                return '<a href="javascript:void(0);" onclick="check(\''+r.id+'\');" class="button button-warning" title="查看赎当详情">查看赎当详情</a>';
                            }
                        }
                    }
                ] ]
