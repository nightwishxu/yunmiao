	...
	<script type="text/javascript">
        ...
        var addFun = function() {
            var dialog = parent.sy.modalDialog({
                ...
                width : 800,
                height : 600,
                url : sy.contextPath + '/go.do?path=store/supplierOrder/edit&goodsSource='+goodsSource,
                buttons : [ {
                    text : '确定',
                    handler : function() {
        ...
        var editFun = function() {
            ...
            var dialog = parent.sy.modalDialog({
                ...
                width : 800,
                height : 600,
                url : sy.contextPath + '/go?path=store/supplierOrder/edit&id=' + rows[0].id,
                buttons : [ {
                    text : '确定',
                    handler : function() {
                        dialog.find('iframe').get(0).contentWindow.submitForm(dialog, grid, parent.$);
        ...
        $(function() {
            grid = $('#grid').datagrid({
                url : sy.contextPath + '/order/orderAdminList?goodsSource='+4,
                columns : [ [ {
