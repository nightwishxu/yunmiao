    ...
    <script type="text/javascript">
        ...
        var addFun = function () {
            var dialog = parent.sy.modalDialog({
                ...
                width: 800,
                height: 600,
                url: sy.contextPath + '/go.do?path=pawnOrgs/supplierOrgEdit',
                buttons: [{
                    text: '添加',
                    handler: function () {
        ...
        var editFun = function () {
            ...
            var dialog = parent.sy.modalDialog({
                ...
                width: 800,
                height: 600,
                url: sy.contextPath + '/go.do?path=pawnOrgs/supplierOrgEdit&id=' + rows[0].id,
                buttons: [{
                    text: '编辑',
                    handler: function () {
                        dialog.find('iframe').get(0).contentWindow.submitForm(dialog, grid, parent.$);
        ...
        var creditsFun = function () {
            ...
            var url = sy.contextPath + '/go.do?path=pawnOrgs/supplierOrgEdit&id=' + rows[0].id;
            var dialog = parent.sy.modalDialog({
                title: '添加机构',
                width: sy.width - 150,
        ...
        var pwdFun = function () {
            ...
            var dialog = parent.sy.modalDialog({
                title: '修改密码',
                height: 220,
                url: sy.contextPath + '/go.do?path=common/pwdEdit&type=3&id=' + rows[0].id,
                buttons: [{
                    text: '编辑',
                    handler: function () {
                        dialog.find('iframe').get(0).contentWindow.submitForm(dialog, grid, parent.$);
        ...
        $(function () {
            grid = $('#grid').datagrid({
                url: sy.contextPath + '/pawnOrg/list?type=3',
                columns: [[{
